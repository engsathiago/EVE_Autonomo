...
# Registry de handlers para eventos finetune.* (sem handler = silencioso)
_finetune_handlers: list[Any] = []


def register_finetune_handler(handler: Any) -> None:
    """Registra um coroutine handler(event_type, data) para eventos finetune.*"""
    _finetune_handlers.append(handler)
